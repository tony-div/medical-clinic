...
export default function AppointmentDetails() {
    ...
    const submitReview = () => {
        ...
        if (docIndex !== -1) {
            ...
            if (alreadyReviewed) {
                alert("You have already reviewed this doctor! You cannot submit multiple reviews.");
            ...
            alert("Thank you! Your review has been added to the doctor's profile.");
            setShowReviewModal(false);
        } else {
            alert("Error: Could not find doctor profile to update.");
        }
    };
        ...
        return (
            <div className="dashboard-layout">
                ...
                <main className="dashboard-main">
                    <button className="back-btn" onClick={() => navigate('/patient/appointments')}>← Back</button>
                    <div className="details-container" style={{textAlign:'center', marginTop:'50px'}}>
                        <h1 style={{color:'#C0392B'}}>🚫 Appointment Cancelled</h1>
                        <p>This appointment was cancelled on {appointment.date}. Details are no longer available.</p>
                    </div>
                </main>
            </div>
        );
                    ...
                    <div className="details-grid">
                        ...
                        {appointment.status === "Completed" ? (
                            ...
                            <div className="report-card empty">
                                <h3>⏳ Visit Pending</h3>
                                <p>The doctor has not entered a diagnosis yet. Please check back after your visit.</p>
                            </div>
                        )}
                    </div>
                </div>
