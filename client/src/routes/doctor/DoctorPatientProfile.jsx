...
import { DB_APPOINTMENTS_KEY, DB_PATIENTS_KEY } from '../../data/initDB'; // Import Patients Key
...
export default function DoctorPatientProfile() {
    ...
    useEffect(() => {
        ...
        // 1. Get Patient General Profile (Source of Truth)
        ...
        // 2. Calculate Age from DOB if available
            ...
            <main className="dashboard-main">
                ...
                <div className="profile-content" style={{paddingTop:'0'}}>
                    ...
                    <div className="profile-card left-card" style={{width:'100%', marginBottom:'30px'}}>
                        ...
                        {/* Updated Details Section (Removed Blood Type) */}
                        <div className="profile-details" style={{display:'flex', gap:'50px', marginTop:'20px'}}>
                            <div>
                                <span style={{color:'#777', display:'block', fontSize:'0.9rem'}}>Gender</span>
                                <strong style={{textTransform:'capitalize'}}>{patientInfo.gender}</strong>
                            </div>
                            <div>
                                <span style={{color:'#777', display:'block', fontSize:'0.9rem'}}>Age</span>
